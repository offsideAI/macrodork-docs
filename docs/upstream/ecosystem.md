# Upstream Ecosystem Guide

> Reference material about the **upstream** robot (Pollen Robotics' Microduck) that Macrodork is
> derived from. Names, repositories and figures below are upstream's and the community's, not
> this project's. See [`provenance.md`](provenance.md) for what upstream has published.

Upstream material is scattered across several GitHub organisations and three HuggingFace resource
...
| Name | ♥ | Note |
|---|---|---|
| [**pollen-robotics/microduck-simulator**](https://huggingface.co/spaces/pollen-robotics/microduck-simulator) | **374** | ⭐ **The official web simulator - open it and play**, nothing to install. Start here if you want a first feel for it |
...
`beak-throw` (throwing with the beak), `electric-slide`, `swing`, `stilts`, `running`.
...
| Repository | ★ | What it is |
|---|---|---|
| **Macrodork (this repository)** | - | Assembly drawings + CAD assemblies + printable parts + full electronics teardown |
| [IronSpiderMan/MicroDuckModels](https://github.com/IronSpiderMan/MicroDuckModels) | 30 | **Chinese.** Three.js web 3D viewer, assembled interactively along the kinematic tree |
| [ScrapMeta/microduck-diy](https://github.com/ScrapMeta/microduck-diy) | 16 | **Chinese.** A "build one by hand in a month" challenge log |
| [SaberOnGo/open-microduck](https://github.com/SaberOnGo/open-microduck) | 7 | Bilingual (Chinese/English) hardware documentation (**documentation only - no PCB files**) |
...
| See what it looks like and how it goes together | [`cad/`](../../cad/) and [`assembly-drawings/`](../../assembly-drawings/) in this repository |
| Print parts | [`print/`](../../print/) in this repository |
| Understand the electronics | [`docs/hardware-teardown.md`](../hardware-teardown.md) in this repository |
