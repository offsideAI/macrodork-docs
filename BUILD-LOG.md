...
> Each entry is written as symptom → cause → fix. Unsolved ones say "unsolved".
...
> That means the conclusion in [fastener reconstruction](docs/fastener-reconstruction.md) -
> that the whole robot is an M2 screw system - holds on physical parts, at least for these
> holes.
>
> Precise measured hole diameters still to come; see the "Dimensional Verification" table above.
